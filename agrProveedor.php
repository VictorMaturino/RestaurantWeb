        ...
        <div id="formulario" class="column is-two-thirds tabla">
            ...
            <form action="insertarProveedores.php" method="POST">
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input id="compania" class="input" type="text" name="compania" placeholder="Nombre" required>
                    </div>
                </div>
                <br>
                <div class="field is-horizontal">
                    ...
                    <div class="control">
                        <input id="txtNombreContacto" class="input txtFormulario" type="text" name="nombreContacto" placeholder="Nombre" required>
                    </div>
                </div>
                <div class="field is-horizontal">
                    <label for="nombre" class="label">Telefono contacto</label>
                    <div class="control">
                        <input id="txtContacto" class="input txtFormulario" type="number" name="contacto" placeholder="Telefono" required>
                    </div>
                </div>
            </form>
        </div>
