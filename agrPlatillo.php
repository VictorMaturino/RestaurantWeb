        ...
        <div id="formulario" class="column is-two-thirds tabla">
            ...
            <form action="insertarPlatillo.php" method="POST">
                <div class="field">
                    ...
                    <div class="control">
                        <input id="txtNombre" class="input" type="text" name="nombre" placeholder="Nombre" required>
                    </div>
                </div>
                <br>
                <div class="field is-horizontal">
                    ...
                    <div class="control">
                        <input id="txtPrecio" class="input" type="number" name="precio" placeholder="Precio" required>
                        <div class="control">
                        </div>
                    </div>
