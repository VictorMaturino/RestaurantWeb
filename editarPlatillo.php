...
<body>
    ...
    <div class="columns">
        <div id="formulario" class="column is-two-thirds tabla">
            ...
            $id=$_GET["var"];
            $consulta = "SELECT * FROM platillos WHERE id_platillo='$id'";
            ...
            while($fila = $registros->fetch_assoc()){
                ...
                $comentario=$fila['ingredientes'];
                $precio=$fila['precio'];
                $tipo=$fila['tipo'];
            }
            ?>
            <form action="insertarPlatillo.php?editar=si&var=<?php echo $id;?>" method="POST">
                <div class="field">
                <label for="nombre" class="label">EDITAR</label>
                    ...
                    <div class="control">
                        <input id="txtNombre"  value="<?php echo $nombreP;?>" class="input" type="text" name="nombre" placeholder="Nombre" required>
                    </div>
                </div>
                <br>
                <div class="field is-horizontal">
                    ...
                    <div class="control">
                        <input id="txtPrecio"  value="<?php echo $precio;?>" class="input" type="number" name="precio" placeholder="Precio" required>
                        <div class="control">
                        </div>
                    </div>
                ...
                <label for="nombre" class="label">Comentario</label>
                    <div class="control">
                        <input id="txtComentario"  value="<?php echo $comentario;?>" class="textarea" type="text" name="comentario" placeholder="Ingredientes..." required>
                    </div>
                </div>
